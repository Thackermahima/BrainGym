        ...
        <li key={option.id}>
          <label className="flex items-center cursor-pointer w-full">
            <input
              type="checkbox"
              id={option.id}
              className="h-5 w-5 mr-2 rounded border-jacarta-200 text-accent checked:bg-accent focus:ring-jacarta-500/20 focus:ring-offset-0 dark:border-jacarta-500 dark:bg-jacarta-600"
